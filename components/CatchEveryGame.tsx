...
export function CatchEveryGame() {
  return (
    <section className="relative grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
      <div>
        <SectionTag size="md" tilt={-2}>Catch Every Game</SectionTag>
        <h2 className="heading-display text-5xl sm:text-7xl text-white mt-5">
          Every game.<br />
          <span className="text-heat">Every screen.</span>
        </h2>
        <p className="mt-5 font-body text-white/85 text-base sm:text-lg leading-relaxed max-w-xl">
        ...
        <SportIconsRow size={56} className="mt-7" />

        <ul className="mt-7 space-y-2 text-white/85 font-body">
